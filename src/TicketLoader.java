...
//with reflection get number of classes' fields.
            ...
            try {
                if (line.startsWith("1")) {
                    ...
                    if (concertArray.length == (totalNumberOfFieldsOfConcertClass + 1)) {
                        Concert c = new Concert(concertArray[1], concertArray[2], concertArray[3], concertArray[4],
                                Integer.parseInt(concertArray[5]), Double.parseDouble(concertArray[6]));
                    ...
                    if (volleyArray.length == (totalNumberOfFieldsOfVolleyClass + 1)) {
                        VolleyballMatch v = new VolleyballMatch(volleyArray[1], volleyArray[2], volleyArray[3],
                                volleyArray[4], volleyArray[5], Integer.parseInt(volleyArray[6]),
                                Double.parseDouble(volleyArray[7]));
